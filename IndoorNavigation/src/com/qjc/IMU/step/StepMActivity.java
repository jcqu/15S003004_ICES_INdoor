...
public class StepMActivity extends StepActivity implements IStepListener {
    ...
    private static final String LOG_FILENAME = "'ICES'-dd-MM-yyyy-HH-mm-ss'.csv'";
    private static final String LOG_DIRNAME  = "ICES-data";
    private static final String TAG          = "ICES-data";
